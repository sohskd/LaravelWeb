...
<html lang="en">
    ...
    <head>
        ...
        <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700subset=all" rel="stylesheet" type="text/css" />
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="index.html">
                            <img src="../assets/pages/img/background/1.jpg" alt="logo" class="logo-default" /> </a>
